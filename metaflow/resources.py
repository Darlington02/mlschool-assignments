...
class Resources(FlowSpec):
    """A flow that showcases how to request computing resources"""
    ...
    def start(self):
        ...
        # we want to create a matrix that requires 1024MB of memory, so let's calc
        # the number of elements that will fit in that memory
